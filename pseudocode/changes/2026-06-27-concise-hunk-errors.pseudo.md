...
Make failed patch hunk diagnostics point to the patch line first and stop echoing long locator text.
...
When rejecting malformed patch syntax with a known source line:
  ...
  describe the expected row type or locator type briefly
  do not echo the full offending row or long locator content
...
When a hunk has no matches:
  ...
  do not echo the full match pattern or quote locator text
